    ...
    <div class="container">
        ...
        <center>
            <div class="row uniform">
                ...
                <div class="6u 12u$(xsmall)">
                    <button class="button fit" onclick="document.getElementById('id03').style.display='block'" style="width:auto">REGISTER AS BUYER</button>
                </div>
            </div>
        </center>
...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
    ...
    <div class="footer-left">
        <h3 style="font-family: 'Times New Roman', cursive;">AgroZon &copy; </h3>
    ...
    <div class="footer-center">
        <div>
            ...
            <p style="font-size:20px">AgroZon<span>Mangaluru</span></p>
        </div>
        <div>
        ...
        <div>
            ...
            <p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">AgroZon@gmail.com</a></p>
        </div>
    </div>

    <div class="footer-right">
        <p class="footer-company-about" style="color:white">
            <span style="font-size:20px"><b>Designed by</b></span>
        <p>Manish R T <br>Karthik N Kulal</p>
...
<div id="id03" class="modal">
    ...
    <form class="modal-content animate" action="Login/signUpbuyer.php" method='POST'>
        <div class="imgcontainer">
        ...
        <div class="container">
            ...
            <section>
                ...
                <form method="post" action="Login/signUpbuyer.php" >
                    <center>
                        <div class="row uniform">
                            <div class="3u 12u$(xsmall)">
                                <input type="text" name="name" id="name" value="" placeholder="Name" required/>
